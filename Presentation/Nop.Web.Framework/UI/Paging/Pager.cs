        ...
        public virtual string GenerateHtmlString()
		{
            ...
            if (showPagerItems && (model.TotalPages > 1))
            {
                ...
                if (showPrevious)
                {
                    ...
                    {
                        links.Append(CreatePageLink(model.PageIndex, "<i class=\"material-icons\">chevron_left</i>", "previous-page"));
                    }
                }
                ...
                if (showNext)
                {
                    ...
                    {
                        links.Append(CreatePageLink(model.PageIndex + 2, "<i class=\"material-icons\">chevron_right</i>", "next-page"));
                    }
                }
                if (showLast)
                {
