...
namespace Nop.Web.Framework.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<ProductLogService>().As<IProductLogService>().InstancePerLifetimeScope();
            builder.RegisterType<PriceLogService>().As<IPriceLogService>().InstancePerLifetimeScope();
            builder.RegisterType<StockLogService>().As<IStockLogService>().InstancePerLifetimeScope();
            builder.RegisterType<ManufacturerLogService>().As<IManufacturerLogService>().InstancePerLifetimeScope();
            builder.RegisterType<CustomerPointService>().As<ICustomerPointService>().InstancePerLifetimeScope();
            builder.RegisterType<BadgeService>().As<IBadgeService>().InstancePerLifetimeScope();
            builder.RegisterType<LevelService>().As<ILevelService>().InstancePerLifetimeScope();
            builder.RegisterType<LevelHistoryService>().As<ILevelHistoryService>().InstancePerLifetimeScope();
            builder.RegisterType<CustomerBadgeService>().As<ICustomerBadgeService>().InstancePerLifetimeScope();
            builder.RegisterType<CustomerBalanceService>().As<ICustomerBalanceService>().InstancePerLifetimeScope();
            builder.RegisterType<RewardItemService>().As<IRewardItemService>().InstancePerLifetimeScope();
            builder.RegisterType<SmsVerificationService>().As<ISmsVerificationService>().InstancePerLifetimeScope();
            builder.RegisterType<SpecialDiscountTakeXPayYService>().As<ISpecialDiscountTakeXPayYService>().InstancePerLifetimeScope();
