...
namespace Nop.Web.Framework.Seo
{
    ...
    public class GenericPathRoute : LocalizedRoute
    {
        ...
        protected RouteValueDictionary GetRouteValues(RouteContext context)
        {
            ...
            if (path.StartsWith("/categorias/", StringComparison.OrdinalIgnoreCase)
               || path.StartsWith("/productos/", StringComparison.OrdinalIgnoreCase))
            {
                path = path.RemoveLanguageSeoCodeFromUrl(context.HttpContext.Request.PathBase, false);
            }
        ...
        public override Task RouteAsync(RouteContext context)
        {
            ...
            switch (urlRecord.EntityName.ToLowerInvariant())
            {
                ...
                case "topic":
                    ...
                    break;
                case "custompage":
                    currentRouteData.Values["controller"] = "CustomPage";
                    currentRouteData.Values["action"] = "CustomPageDetails";
                    currentRouteData.Values["customPageId"] = urlRecord.EntityId;
                    currentRouteData.Values["SeName"] = urlRecord.Slug;
                    break;
                default:
