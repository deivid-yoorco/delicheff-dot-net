...
namespace Nop.Web.Areas.Admin.Extensions
{
    public static class MappingExtensions
    {
        ...
        public static GrowthHackingModel ToModel(this GrowthHackingSettings entity)
        {
            return entity.MapTo<GrowthHackingSettings, GrowthHackingModel>();
        }

        public static GrowthHackingSettings ToEntity(this GrowthHackingModel model, GrowthHackingSettings destination)
        {
            return model.MapTo(destination);
        }
