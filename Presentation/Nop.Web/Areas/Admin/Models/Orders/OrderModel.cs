...
namespace Nop.Web.Areas.Admin.Models.Orders
{
    public partial class OrderModel : BaseNopEntityModel
    {
        ...
        [NopResourceDisplayName("Admin.Orders.Fields.OrderDiscountAppliedToProductsOrCategories")]
        public string OrderDiscountAppliedToProductsOrCategories { get; set; }
        [NopResourceDisplayName("Admin.Orders.Fields.OrderDiscountAppliedToProductsOrCategoriesValue")]
        public decimal OrderDiscountAppliedToProductsOrCategoriesValue { get; set; }
        ...
        [NopResourceDisplayName("Admin.Orders.Fields.CustomerBalanceUsedAmount")]
        ...
        [NopResourceDisplayName("Distribución de cajas")]
        public string BoxesDistribution { get; set; }
        ...
        public string CreatedOnCustomString { get; set; }
        ...
        public bool OrderHasReport { get; set; }

        public int RouteId { get; set; }

        public string ShippingProviderNotificationDate { get; set; }

        //facturify
        public bool isFacurifyInstalled { get; set; }
        public BillModel Bill { get; set; }
        public List<CustomerFacturifyAddress> CustomerFacturifyAddresses { get; set; }
        public bool AllowGeneration { get; set; }

        public List<ProductCode> ProductsWhihoutCode { get; set; }
        ...
        public partial class OrderItemModel : BaseNopEntityModel
        {
            ...
            public decimal UnitRewardPointsRequired { get; set; }
            ...
            public string FancyDesign { get; set; }
    ...
    public class CustomerFacturifyAddress
    {
