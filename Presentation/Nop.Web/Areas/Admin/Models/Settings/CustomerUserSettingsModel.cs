...
namespace Nop.Web.Areas.Admin.Models.Settings
{
    public partial class CustomerUserSettingsModel : BaseNopModel
    {
        public CustomerUserSettingsModel()
        {
            ...
            SmsVerificationSettings = new SmsVerificationSettingsModel();
        }
        ...
        public SmsVerificationSettingsModel SmsVerificationSettings { get; set; }
        ...
        public partial class SmsVerificationSettingsModel : BaseNopModel
        {
            [NopResourceDisplayName("Admin.Configuration.Settings.SmsVerification.IsActive")]
            public bool IsActive { get; set; }

            [NopResourceDisplayName("Admin.Configuration.Settings.SmsVerification.IsSandbox")]
            public bool IsSandbox { get; set; }

            [NopResourceDisplayName("Admin.Configuration.Settings.SmsVerification.MinutesForCodeRequest")]
            public int MinutesForCodeRequest { get; set; }

            [NopResourceDisplayName("Admin.Configuration.Settings.SmsVerification.SandboxApiKey")]
            public string SandboxApiKey { get; set; }

            [NopResourceDisplayName("Admin.Configuration.Settings.SmsVerification.ApiKey")]
