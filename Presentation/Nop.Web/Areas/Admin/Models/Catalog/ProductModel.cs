...
namespace Nop.Web.Areas.Admin.Models.Catalog
{
    ...
    public partial class ProductModel : BaseNopEntityModel, ILocalizedModel<ProductLocalizedModel>
    {
        public ProductModel()
        {
            ...
            ProductLog = new List<ProductLog>();
        }
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ParentSku")]
        ...
        public string PropertiesOptions { get; set; }

        public decimal WeightInterval { get; set; }

        public int WalmartProductId { get; set; }

        public int LaComerProductId { get; set; }

        public int SuperamaProductId { get; set; }

        public int ChedrauiProductId { get; set; }
        ...
        public IList<ProductLog> ProductLog { get; set; }

        public bool AllowAutoUpdatePrice { get; set; }

        public int NumberProducts { get; set; }
        public bool GiftProductEnable { get; set; }
        public decimal GiftProductMinimumAmount { get; set; }

        public string ShippingText { get; set; }
        public bool ShippingTextEnable { get; set; }

        public string ProductCatalogId { get; set; }

        public bool IsExtraCartProduct { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.RewardPointsRequired")]
        public decimal RewardPointsRequired { get; set; }
        ...
        public partial class ProductPictureModel : BaseNopEntityModel
        {
            ...
            [NopResourceDisplayName("Admin.Catalog.Products.Pictures.Fields.Is360")]
        ...
        public partial class ProductAttributeValueModel : BaseNopEntityModel, ILocalizedModel<ProductAttributeValueLocalizedModel>
        {
            ...
            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.Attributes.Values.Fields.IsSpecialEdition")]
            public bool IsSpecialEdition { get; set; }

            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.Attributes.Values.Fields.ProductAwards")]
            public IList<int> ProductAwards { get; set; }

            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.Attributes.Values.Fields.IsNew")]
            public bool IsNew { get; set; }

            public IList<SelectListItem> ListAwards { get; set; }
        ...
        public partial class ProductAttributeCombinationModel : BaseNopEntityModel
        {
            ...
            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.AttributeCombinations.Fields.ParentSku")]
            public string ParentSku { get; set; }
