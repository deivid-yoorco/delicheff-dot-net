...
using static Nop.Services.Catalog.PriceCalculationService;
...
namespace Nop.Web.Models.ShoppingCart
{
    public partial class ShoppingCartModel : BaseNopModel
    {
        ...
        public string CartInSesionJson { get; set; }
        ...
        public bool ShowIsGift{ get; set; }
        ...
        public partial class ShoppingCartItemModel : BaseNopEntityModel
        {
            public ShoppingCartItemModel()
            {
                ...
                ProductManufacturerNames = new List<string>();
                AppliedSpecialPromotionIds = new List<int>();
            }
            ...
            public string UnitpriceWhitoutDiscount { get; set; }
            ...
            public List<string> ProductManufacturerNames { get; set; }

            public bool GiftProductEnable { get; set; }
            public bool? IsRewardItem { get; set; }
            //public string AppliedByCodeByCoupon { get; set; }

            public List<int> AppliedSpecialPromotionIds { get; set; }
            public string SubTotalWithoutSpecialPromotions { get; set; }
            public string AppliedSpecialPromotionText { get; set; }
        }
        ...
        public partial class DiscountBoxModel: BaseNopModel
        {
            public DiscountBoxModel()
            {
                ...
                DiscountViewList = new List<Discount>();
                RewardItemList = new List<RewardItemModel>();
            }

            public List<Discount> DiscountViewList { get; set; }
            public List<RewardItemModel> RewardItemList { get; set; }
        ...
        public partial class ExtraShoppingCartProductModel
        {
            public ExtraShoppingCartProductModel()
            {
                Items = new List<ShoppingCartItemModel>();
            }
