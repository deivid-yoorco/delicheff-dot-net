    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        public virtual HeaderLinksModel PrepareHeaderLinksModel()
        {
            ...
            var model = new HeaderLinksModel
            {
                ...
                CustomerProfilePicture = TeedCommerceStores.CurrentStore == TeedStores.CentralEnLinea 
                && customer.ProfilePictureId > 0 ?
                _pictureService.GetPictureUrl(customer.ProfilePictureId ?? 0, 100) : string.Empty,
                GamificationIsActive = settings.IsActive,
                CustomerPointsBalance = _customerPointService.GetCustomerPointsBalance(customer.Id),
            };
            ...
            model.CompareProducstItems = _compareProductsService.GetCompareProductsCount();
        ...
        public virtual FaviconModel PrepareFaviconModel()
        {
            ...
            var faviconFileName = $"favicon-{Enum.GetName(typeof(TeedStores), TeedCommerceStores.CurrentStore)}.ico";
