...
namespace Nop.Web.Factories
{
    public partial class CatalogModelFactory : ICatalogModelFactory
    {
        ...
        public virtual CategoryModel PrepareCategoryModel(Category category, CatalogPagingFilteringModel command)
        {
            ...
            IList<int> alreadyFilteredSpecOptionIds2 = model.PagingFilteringContext.SpecificationFilter.GetAlreadyFilteredSpecOptionIds(_webHelper);
            ...
            var productsAll = _productService.SearchProducts(out IList<int> filterableSpecificationAttributeOptionIds2,
                true,
                categoryIds: categoryIds,
                storeId: _storeContext.CurrentStore.Id,
                visibleIndividuallyOnly: true,
        ...
        public virtual CategoryNavigationModel PrepareCategoryNavigationModel(int currentCategoryId, int currentProductId)
        {
            ...
            var model = new CategoryNavigationModel
            {
                ...
                CurrentCategoryParentId = _categoryService.GetCategoryById(activeCategoryId)?.ParentCategoryId ?? 0,
        ...
        /// <summary>
        /// Prepare rewards products model
        /// </summary>
        /// <param name="command">Catalog paging filtering command</param>
        /// <returns>ProductReward model</returns>
        public virtual ProductRewardModel PrepareRewardsModel(CatalogPagingFilteringModel command)
        {
            var model = new ProductRewardModel
            {
                Title = "",
                Description = "",
                Picture = ""
            ...
            PrepareViewModes(model.PagingFilteringContext, command);
            //page size
            PreparePageSizeOptions(model.PagingFilteringContext, command, false, "36", 36);
        ...
        public virtual ManufacturerModel PrepareManufacturerModel(Manufacturer manufacturer, CatalogPagingFilteringModel command)
        {
            ...
            var model = new ManufacturerModel
            {
                ...
                DisplayDescription = manufacturer.DisplayDescription,
                DisplayPicture = manufacturer.DisplayPicture
            };

            var picture = _pictureService.GetPictureById(manufacturer.PictureId);
            var FullSizeImageUrl = _pictureService.GetPictureUrl(picture);

            model.PictureModel.FullSizeImageUrl = FullSizeImageUrl;
        ...
        public virtual SearchModel PrepareSearchModel(SearchModel model, CatalogPagingFilteringModel command)
        {
            ...
            if (isSearchTermSpecified)
            {
                ...
                else
                {
                    ...
                    //products
                    products = _productService.SearchProducts(out bool notFoundOptimized,
                        categoryIds: categoryIds,
                        ...
                        vendorId: vendorId);
                    model.Products = _productModelFactory.PrepareProductOverviewModels(products).ToList();
                    model.NotFoundOptimized = notFoundOptimized;
