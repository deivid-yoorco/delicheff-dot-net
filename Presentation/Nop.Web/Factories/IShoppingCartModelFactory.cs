...
namespace Nop.Web.Factories
{
    ...
    public partial interface IShoppingCartModelFactory
    {
        ...
        /// <returns></returns>
        ExtraShoppingCartProductModel PrepareExtraShoppingCartProductModel(ExtraShoppingCartProductModel model,
            IList<ShoppingCartItem> cart, List<Product> extraCartProducts, Customer customer, int storeId);

        List<ShoppingCartItem> CheckIfCartHasDeletedProducts(List<ShoppingCartItem> cart);
    }
}
