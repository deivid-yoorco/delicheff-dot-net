...
namespace Nop.Web.Factories
{
    ...
    public partial class OrderModelFactory : IOrderModelFactory
    {
        ...
        public virtual OrderDetailsModel PrepareOrderDetailsModel(Order order)
        {
            ...
            //balance used
            var orderCustomerBalnceInCustomerCurrency = _currencyService.ConvertCurrency(order.CustomerBalanceUsedAmount ?? 0, order.CurrencyRate);
            model.CustomerBalanceUsedAmount = orderCustomerBalnceInCustomerCurrency;
            model.CustomerBalanceUsed = _priceFormatter.FormatPrice(orderCustomerBalnceInCustomerCurrency, true, order.CustomerCurrencyCode, false, _workContext.WorkingLanguage);
