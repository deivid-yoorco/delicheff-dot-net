...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            // Shipping area
            routeBuilder.MapLocalizedRoute("ShippingArea", "Cobertura/",
                new { controller = "ShippingArea", action = "Cobertura" });

            // Reward levels
            routeBuilder.MapLocalizedRoute("Rewards", "Recompensas/",
                new { controller = "Catalog", action = "Rewards" });
            ...
            routeBuilder.MapLocalizedRoute("ShareAndWin", "customer/shareandwin",
                new { controller = "Customer", action = "ShareAndWin" });
            ...
            routeBuilder.MapLocalizedRoute("CustomerPoints", "customer/customerpoints",
                 new { controller = "Customer", action = "CustomerPoints" });

            routeBuilder.MapLocalizedRoute("CustomerBalance", "customer/customerbalance",
                 new { controller = "Customer", action = "CustomerBalance" });

            routeBuilder.MapLocalizedRoute("Leaderboards", "customer/leaderboards",
                new { controller = "Customer", action = "Leaderboards" });

            routeBuilder.MapLocalizedRoute("CustomerBadges", "customer/customerbadges",
                new { controller = "Customer", action = "CustomerBadges" });
