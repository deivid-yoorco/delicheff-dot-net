...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class GenericUrlRouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            routeBuilder.MapLocalizedRoute("Product", "productos/{SeName}", 
                new { controller = "Product", action = "ProductDetails" });

            routeBuilder.MapLocalizedRoute("Category", "categorias/{SeName}", 
            ...
            routeBuilder.MapLocalizedRoute("CustomPage", "{SeName}",
                new { controller = "CustomPage", action = "CustomPageDetails" });
        }
