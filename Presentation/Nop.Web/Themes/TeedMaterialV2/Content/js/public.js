...
var AjaxCart = {
    ...
    success_process: function (response) {
        ...
        if (response.updatetopwishlistsectionhtml) {
            ...
            $(AjaxCart.topwishlistselector).tooltip('destroy');
            $(AjaxCart.topwishlistselector).attr('data-tooltip', response.updatetopwishlistsectionhtml);
            $(AjaxCart.topwishlistselector).tooltip();
            $('[id="like-checkbox-' + response.productId + '"]').prop('checked', !$('[id="like-checkbox-' + response.productId + '"]').prop('checked'));
        }
