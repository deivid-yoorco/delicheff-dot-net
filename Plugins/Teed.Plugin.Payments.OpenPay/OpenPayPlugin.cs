...
{
    public class OpenPayPlugin : BasePlugin, IWidgetPlugin, IPaymentMethod
    {
        #region Fields
        ...
        public OpenPayPlugin(ILocalizationService localizationService,
        ...
        public override void Install()
        {
            ...
            _widgetSettings.ActiveWidgetSystemNames.Add("Payments.OpenPay");
        ...
        {
            _widgetSettings.ActiveWidgetSystemNames.Remove("Payments.OpenPay");
            _settingService.SaveSetting(_widgetSettings);
            base.Uninstall();
        }
        ...
        {
            viewComponentName = "PaymentOpenPay";
        }
        ...
        {
            return new List<string> { "head_html_tag", "openPay-form" };
        }
        ...
        public void GetPublicViewComponent(string widgetZone, out string viewComponentName)
        {
            ...
            {
                case "head_html_tag":
                    viewComponentName = "OpenPayJs";
                    break;
                case "openPay-form":
                    viewComponentName = "OpenPayForm";
                    break;
                default:
                    viewComponentName = "";
                    break;
