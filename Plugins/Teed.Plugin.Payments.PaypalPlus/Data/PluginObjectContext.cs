...
using Teed.Plugin.Payments.PaypalPlus.Data.Mapping;
using Teed.Plugin.Payments.PaypalPlus.Domain;

namespace Teed.Plugin.Payments.PaypalPlus.Data
{
    public class PluginObjectContext : DbContext, IDbContext
    {
        ...
        {
            modelBuilder.Configurations.Add(new RememberedCardsMap());
