...
(function (factory) {
    ...
    OrgChart.prototype = {
        ...
        exportPDF: function (canvas, exportFilename) {
            ...
            var originalWidth = $('.orgchart').outerWidth() + 20;
            var originalHeight = $('.orgchart').outerHeight() + 20;
            if (docWidth < originalWidth)
                docWidth = originalWidth;
            if (docHeight < originalHeight)
                docHeight = originalHeight;
        ...
        export: function (exportFilename, exportFileextension) {
            var $orgchart = $('.orgchart.ui-draggable');
            if ($orgchart.length > 0) {
                $orgchart.css('top', '0px');
                $orgchart.css('left', '0px');
            }
            var that = this;
