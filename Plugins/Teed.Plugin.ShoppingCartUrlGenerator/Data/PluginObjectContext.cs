...
using Teed.Plugin.ShoppingCartUrlGenerator.Data.Mapping;
using Teed.Plugin.ShoppingCartUrlGenerator.Domain;

namespace Teed.Plugin.ShoppingCartUrlGenerator.Data
{
    public class PluginObjectContext : DbContext, IDbContext
    {
        ...
        {
            modelBuilder.Configurations.Add(new ShoppingCartUrlMap());
            modelBuilder.Configurations.Add(new ShoppingCartUrlUserMap());
            modelBuilder.Configurations.Add(new ShoppingCartUrlProductMap());
