...
using Teed.Plugin.Facturify.Data.Mapping;

namespace Teed.Plugin.Facturify.Data
{
    public class PluginObjectContext : DbContext, IDbContext
    {
        ...
        {
            modelBuilder.Configurations.Add(new CustomerBillingAddressMap());
            modelBuilder.Configurations.Add(new BillMap());
            modelBuilder.Configurations.Add(new CategoryProductCatalogMap());
            modelBuilder.Configurations.Add(new ProductSatCodeMap());
