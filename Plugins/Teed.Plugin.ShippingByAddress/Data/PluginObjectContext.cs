...
using Teed.Plugin.ShippingByAddress.Data.Mapping;
using Teed.Plugin.ShippingByAddress.Domain.ShippingByAddressD;

namespace Teed.Plugin.ShippingByAddress.Data
{
    public class PluginObjectContext : DbContext, IDbContext
    {
        ...
        {
            modelBuilder.Configurations.Add(new ShippingByAddressMap());
            modelBuilder.Configurations.Add(new ShippingBranchMap());
            modelBuilder.Configurations.Add(new ShippingBranchOrderMap());
