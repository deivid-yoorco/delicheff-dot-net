...
{
    public class StripePlugin : BasePlugin, IWidgetPlugin, IPaymentMethod
    {
        #region Fields
        ...
        public StripePlugin(ILocalizationService localizationService,
        ...
        public override void Install()
        {
            ...
            _widgetSettings.ActiveWidgetSystemNames.Add("Payments.Stripe");
        ...
        {
            _widgetSettings.ActiveWidgetSystemNames.Remove("Payments.Stripe");
            _settingService.SaveSetting(_widgetSettings);
            base.Uninstall();
        }
        ...
        {
            return new List<string> { "head_html_tag", "stripe-form" };
        }
        ...
        public void GetPublicViewComponent(string widgetZone, out string viewComponentName)
        {
            ...
            {
                case "head_html_tag":
                    viewComponentName = "StripeJs";
                    break;
                case "stripe-form":
                    viewComponentName = "StripeForm";
                    break;
                default:
                    viewComponentName = "";
                    break;
