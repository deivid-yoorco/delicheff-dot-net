   ...
   /* $('#datepicker').prop('disabled', true);
    ...
    function updateTimes() {
        ...
        for (var i = 5; i < 23; i++) {
            ...
            if (selectedTimes.indexOf(option6.value) > -1) option6.selected = true;
            if (selectedTimes.indexOf(option5.value) > -1) option5.selected = true;
            if (selectedTimes.indexOf(option4.value) > -1) option4.selected = true;
            if (selectedTimes.indexOf(option3.value) > -1) option3.selected = true;
            if (selectedTimes.indexOf(option2.value) > -1) option2.selected = true;
            if (selectedTimes.indexOf(option1.value) > -1) option1.selected = true;
        ...
        //        if (c % 2 == 0) {
        //            value = "0" + i + ":30:00";
        //            var option = new Option("0" + i + ":30", value);
        //        } else {
        //            value = "0" + i + ":00:00";
        //            var option = new Option("0" + i + ":00", value);
        //        }
        //    } else {
        //        if (c % 2 == 0) {
        //            value = i + ":30:00";
        //            var option = new Option(i + ":30", value);
        //        } else {
        //            value = i + ":00:00";
        //            var option = new Option(i + ":00", value);
        //        }
        //    }
        //    c++;
        //    if (value == $("#timepickerValue").val()) {
