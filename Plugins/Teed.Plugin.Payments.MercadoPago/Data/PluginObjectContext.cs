...
using Teed.Plugin.Payments.MercadoPago.Data.Mapping;

namespace Teed.Plugin.Payments.MercadoPago.Data
{
    public class PluginObjectContext : DbContext, IDbContext
    {
        ...
        {
            modelBuilder.Configurations.Add(new MercadoPagoTransactionMap());
            modelBuilder.Configurations.Add(new MercadoPagoApiLogMap());
