...
namespace Teed.Plugin.CustomPages.Services
{
    ...
    {
        private readonly IRepository<Banners> _db;
        private readonly IEventPublisher _eventPublisher;
        private readonly IWorkContext _workContext;

        public BannersService(
            IRepository<Banners> db,
        ...
        public Banners GetByCustomPageId(int id)
        {
            return _db.Table.Where(x => x.CustomPageId == id && !x.Deleted).FirstOrDefault();
        }

        public void Insert(Banners entity)
        {
        ...
        public void Update(Banners entity)
        {
            if (entity == null) throw new ArgumentNullException(nameof(entity));
