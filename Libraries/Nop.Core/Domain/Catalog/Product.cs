...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class Product : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported
    {
        ...
        // <summary>
        /// Set the Equivalence Coefficient of the product (for groceries)
        /// </summary>
        public decimal EquivalenceCoefficient { get; set; }

        // <summary>
        /// Set the PropertiesOptions of the product (for groceries)
        /// </summary>
        public string PropertiesOptions { get; set; }

        // <summary>
        /// Set the Weight Interval of the product (for groceries)
        /// </summary>
        public decimal WeightInterval { get; set; }

        // <summary>
        /// Get or set the WalmartProductId of the product (for groceries)
        /// </summary>
        public int WalmartProductId { get; set; }

        // <summary>
        /// Get or set the LaComerProductId of the product (for groceries)
        /// </summary>
        public int LaComerProductId { get; set; }

        // <summary>
        /// Get or set the SuperamaProductId of the product (for groceries)
        /// </summary>
        public int SuperamaProductId { get; set; }

        // <summary>
        /// Get or set the ChedrauiProductId of the product (for groceries)
        /// </summary>
        public int ChedrauiProductId { get; set; }

        /// <summary>
        /// Get or set if the price should be updated automatically (when apply)
        /// </summary>
        public bool AllowAutoUpdatePrice { get; set; }

        /// <summary>
        /// Gets or sets the Reward Points Required
        /// </summary>
        ...
        /// <summary>
        /// Get or set if is an extra cart product
        /// </summary>
