...
namespace Nop.Core.Domain.Discounts
{
    ...
    public partial class Discount : BaseEntity
    {
        ...
        /// <summary>
        /// Gets or sets the pinture id
        /// </summary>
        public int? PictureId { get; set; }

        /// <summary>
        /// Gets or sets whether the coupon is active or not
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the customer owner id for growth hacking
        /// </summary>
        public int CustomerOwnerId { get; set; }

        /// <summary>
        /// Gets or sets the only customer who can use the discount
        /// </summary>
        public string LimitedToCustomerEmail { get; set; }

        /// <summary>
        /// Gets or sets the order minimum amount
        /// </summary>
        public decimal OrderMinimumAmount { get; set; }

        /// <summary>
        /// Gets or sets the related order id when is a growth hacking reward coupon
        /// </summary>
        public int? RelatedOrderId { get; set; }

        /// <summary>
        /// Gets or sets the Parent th discount
        /// </summary>
        public string ParentId { get; set; }

        /// <summary>
        /// Gets or sets the number series discount
        /// </summary>
        public int? NumSeries { get; set; }

        /// <summary>
        /// Gets or sets bool id massive 
        /// </summary>
        public bool? MassiveCreation { get; set; }

        /// <summary>
        /// Gets or sets bool if discount is visible in extra areas (like product cards)
        /// </summary>
        //public bool? IsExtraVisible { get; set; }

        /// <summary>
        /// Gets or sets string formated ids to which this discount is not allowed to be used with specified discount ids
        /// </summary>
        //public string ExclusiveUsageAgainstIds { get; set; }

        /// <summary>
        /// Gets or sets bool if discount should add specified products to cart when added correctly (Only applies to discounts that apply to products)
        /// </summary>
