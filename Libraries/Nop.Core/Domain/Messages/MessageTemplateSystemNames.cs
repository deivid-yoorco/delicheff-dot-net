namespace Nop.Core.Domain.Messages
{
    ...
    public static partial class MessageTemplateSystemNames
    {
        ...
        /// <summary>
        /// Represents system name of new share code
        /// </summary>
        public const string CustomerNewShareCode = "Customer.NewShareCode";

        /// <summary>
        /// Represents system name of new coupon code
        /// </summary>
        public const string CustomerNewCouponCode = "Customer.NewCouponCode";
