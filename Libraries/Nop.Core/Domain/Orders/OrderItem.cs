...
namespace Nop.Core.Domain.Orders
{
    ...
    public partial class OrderItem : BaseEntity
    {
        ...
        /// </summary>
        public virtual decimal EquivalenceCoefficient { get; set; }

        /// <summary>
        /// The Weight Interval of the product. For groceries.
        /// </summary>
        public virtual decimal WeightInterval { get; set; }
        ...
        /// <summary>
        /// Reward points required to buy this item by unit
        /// </summary>
        public decimal UnitRewardPointsRequired { get; set; }

        /// <summary>
        /// Reward points required to buy the buyed quantity
        /// </summary>
