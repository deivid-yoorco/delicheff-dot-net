...
namespace Nop.Core.Domain.Orders
{
    ...
    public partial class Order : BaseEntity
    {
        ...
        /// <summary>
        /// Gets or sets the original (unmodified) order total
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the custom order payment parameter
        /// </summary>
        public string PaymentParameter { get; set; }

        /// <summary>
        /// Gets or sets the custom order boxes distribution
        /// </summary>
        public string BoxesDistribution { get; set; }

        /// <summary>
        /// Gets or sets the custom order message gift
        /// </summary>
        public string MessageGift { get; set; }

        /// <summary>
        /// Gets or sets the custom order signs gift
        /// </summary>
        public string SignsGift { get; set; }

        /// <summary>
        /// Gets or sets the selected shipping date
        /// </summary>
        public DateTime? SelectedShippingDate { get; set; }

        /// <summary>
        /// Gets or sets the selected shipping time
        /// </summary>
        public string SelectedShippingTime { get; set; }

        /// <summary>
        /// Gets or sets the shipping route id
        /// </summary>
        public int RouteId { get; set; }

        /// <summary>
        /// Gets or sets the shipping route display order
        /// </summary>
        public int RouteDisplayOrder { get; set; }

        /// <summary>
        /// Gets or sets the shipping zone id
        /// </summary>
        public int? ZoneId { get; set; }

        /// <summary>
        /// Gets or sets Total Reward Points Required
        /// </summary>
        public decimal TotalRewardPointsRequired { get; set; }

        /// <summary>
        /// Gets or sets the transfer time regarding previous point in seconds
        /// </summary>
        public int? PreviousPointTransferTime { get; set; }

        /// <summary>
        /// Gets or sets the transfer distance regarding previous point in meters
        /// </summary>
        public int? PreviousPointTransferDistance { get; set; }

        /// <summary>
        /// Gets or sets the rescue route id
        /// </summary>
        public int? RescuedByRouteId { get; set; }

        /// <summary>
        /// Gets or sets the rescue route display order
        /// </summary>
        public int? RescueRouteDisplayOrder { get; set; }

        /// <summary>
        /// Gets or sets the customer balance used in this order
        /// </summary>
