...
namespace Nop.Services.Helpers
{
    ...
    public partial class DateTimeHelper : IDateTimeHelper
    {
        ...
        public virtual DateTime ConvertToUserTimeMaybeNull(DateTime? dt, DateTimeKind sourceDateTimeKind)
        {
            DateTime dtt = dt ?? default;
            dtt = DateTime.SpecifyKind(dtt, sourceDateTimeKind);
            var currentUserTimeZoneInfo = CurrentTimeZone;
            return TimeZoneInfo.ConvertTime(dtt.Date, currentUserTimeZoneInfo);
        }
