...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderTotalCalculationService
    {
        ...
        decimal GetBalanceTotalByOrderTotalOrCart(Customer customer, decimal? orderTotal = null, IList<ShoppingCartItem> cart = null);
        ...
        decimal GetBalanceTotal(Customer customer);
        ...
        /// <returns></returns>
        bool IsFreeShippingByShippingOption(IList<ShoppingCartItem> cart, ShippingOption shippingOption);
    }
}
