...
namespace Nop.Services.Orders
{
    ...
    public partial interface IShoppingCartService
    {
        ...
        void AddGiftProduct(Customer customer, int storeId);
        ...
        /// <param name="deleteProductsOnSesion">A value indicating To Costumer ShoppingCartItems should be deleted</param>
        ...
        void DeleteMigrateShoppingCart(Customer customer, int[] cartItemsIdToRemove);
    }
}
