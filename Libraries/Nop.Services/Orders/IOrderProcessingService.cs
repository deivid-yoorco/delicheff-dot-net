...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderProcessingService
    {
        ...
        PlaceOrderResult PlaceOrder(ProcessPaymentRequest processPaymentRequest, List<int> shoppingCartItemIds = null);
        ...
        void GenerateRewardCouponCode(Order order, GrowthHackingSettings growthHackingSettings);
        ...
        void ActivateGrowHackingForCustomer(Customer customer,
        ...
        string GetMinOrderSubtotalAmountMessage(IList<ShoppingCartItem> cart);
        ...
        string GetMinOrderTotalAmountMessage(IList<ShoppingCartItem> cart);
        ...
        bool ShouldCheckForOrderMinimumValidation(Customer customer, DateTime? dateForCheckUtc = null);
