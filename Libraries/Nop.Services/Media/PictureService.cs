...
namespace Nop.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
            ...
            PictureType defaultPictureType = PictureType.Entity)
        {
            ...
            if (picture.IsNew)
            {
                ...
                picture = UpdatePicture(picture.Id,
                    ...
                    picture.Is360,
                    picture.CustomEnable,
                    picture.BoundingX,
                    picture.BoundingY,
                    picture.BoundingWidth,
                    picture.BoundingHeight,
                    false,
                    false);
            }
        ...
        /// <param name="defaultPictureType">Default picture type</param>
        /// <returns>Picture URL</returns>
        public virtual List<SelectListItem> GetPictureUrls(List<Product> products,
            int targetSize = 0,
            bool showDefaultPicture = true,
            string storeLocation = null,
            PictureType defaultPictureType = PictureType.Entity)
            ...
            foreach (var product in products)
            {
                foreach (var pic in product.ProductPictures)
                {
                    selectLists.Add(new SelectListItem
                    {
                        ...
                        Text = GetPictureUrl(pic.Picture, targetSize, showDefaultPicture, storeLocation, defaultPictureType)
                    });
                }
            }
            return selectLists;
        ...
        public virtual Picture UpdatePicture(int pictureId, byte[] pictureBinary, string mimeType,
            ...
            bool is360 = false, bool customEnable = false, string boundingX = null,
            string boundingY = null, string boundingWidth = null, string boundingHeight = null,
            bool isNew = true, bool validateBinary = true)
        {
            mimeType = CommonHelper.EnsureNotNull(mimeType);
            mimeType = CommonHelper.EnsureMaximumLength(mimeType, 20);
            ...
            picture.IsNew = isNew;
            picture.Is360 = is360;
            picture.CustomEnable = customEnable;
            picture.BoundingX = boundingX;
            picture.BoundingY = boundingY;
            picture.BoundingWidth = boundingWidth;
            picture.BoundingHeight = boundingHeight;
