...
namespace Nop.Services.Messages
{
    ...
    public partial interface IWorkflowMessageService
    {
        ...
        /// <returns></returns>
        int SendCustomerNewShareCode(Customer customer, int languageId, string discountCode, string rewardAmount);
        ...
        /// <returns></returns>
       int SendCustomerNewCouponCode(Customer customer, int languageId, string couponCode, string couponReason, List<string> couponConditions);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendCustomerWelcomeMessage(Customer customer, int languageId, int discountId = 0);
        ...
        /// <returns>Queued email identifier</returns>
        int SendOrderPlacedStoreOwnerNotification(Order order, int languageId, string branchEmail = null);
