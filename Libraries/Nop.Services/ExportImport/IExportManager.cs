...
namespace Nop.Services.ExportImport
{
    ...
    public partial interface IExportManager
    {
        ...
        /// </summary>
        /// <param name="products">Products</param>
        byte[] ExportFacebookProductsToXlsx(IEnumerable<Product> products, string store, string urlStore);
        ...
        /// <summary>
        /// Export shopping list to XLSX
        /// </summary>
        /// <param name="orders">Orders</param>
        /// <param name="selectedDate">Selected shipping date</param>
        byte[] ExportShoppingListToXlsx(IList<Order> orders, DateTime selectedDate);
        ...
        byte[] ExportMassiveDiscountsToXlsx(IEnumerable<Discount> discounts);
    }
}
