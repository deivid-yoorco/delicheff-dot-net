...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        /// <returns></returns>
        IQueryable<Product> GetAllProductsQuery(bool includeDeleted = false);
        ...
        IList<Product> GetUnpublishedProducts();
        IList<Product> GetPublishedProducts();
        ...
        /// <returns>Products</returns>
        IPagedList<Product> SearchProducts(int pageIndex = 0,
        ...
        /// <param name="calculateLevenshteinDistance">A value indicating whether to order result by levenshtein distance</param>
        /// <returns>Products</returns>
        IPagedList<Product> SearchProducts(out IList<int> filterableSpecificationAttributeOptionIds,
        ...
        /// Search products
        /// </summary>
        /// <param name="notFoundOptimized">Get if not results found and using optimized result</param>
        /// <param name="pageIndex">Page index</param>
        /// <param name="pageSize">Page size</param>
        /// <param name="categoryIds">Category identifiers</param>
        /// <param name="manufacturerId">Manufacturer identifier; 0 to load all records</param>
        ...
        /// <param name="calculateLevenshteinDistance">A value indicating whether to order result by levenshtein distance</param>
        /// <returns>Products</returns>
        IPagedList<Product> SearchProducts(out bool notFoundOptimized,
            int pageIndex = 0,
            int pageSize = int.MaxValue,
            IList<int> categoryIds = null,
            int manufacturerId = 0,
        ...
        /// <summary>
        /// Get published products marked as gifts
        /// </summary>
        /// <returns></returns>
        ...
        /// <returns>Products</returns>
        IList<Product> GetProductsBySku(string[] skuArray, int vendorId = 0, bool checkWithoutLeadingZeros = false);
