...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductAttributeService : IProductAttributeService
    {
        ...
        public virtual IList<ProductAttributeMapping> GetAllAttributeMappings()
        {
        ...
        /// <summary>
        /// Gets all product attribute values
        /// </summary>
        /// <returns>Product attribute mapping collection</returns>
        public virtual IList<ProductAttributeValue> GetAllProductAttributeValues()
        {
        ...
        /// <param name="productAttributeValueId">Product attribute value identifier</param>
        /// <returns>Product attribute value</returns>
        public virtual ProductAttributeValue GetProductAttributeValueBySkuAndColor(string sku, string color)
        {
            if (sku == null)
                return null;

            var key = string.Format(PRODUCTATTRIBUTEVALUES_BY_ID_KEY, sku+color);
            var dataReturn = _cacheManager.Get(key, () => _productAttributeValueRepository.TableNoTracking.Where(x => x.ProductAttributeMapping.Product.Sku == sku && x.Name == color).FirstOrDefault());
            return dataReturn;
        }
        ...
        /// <summary>
        /// Gets all product attribute combinations by SKU
        /// </summary>
        /// <param name="sku">SKU</param>
        /// <returns>Product attribute combination</returns>
        public virtual IList<ProductAttributeCombination> GetAllProductAttributeCombinationsBySku(string sku)
        {
            if (string.IsNullOrEmpty(sku))
                return null;
