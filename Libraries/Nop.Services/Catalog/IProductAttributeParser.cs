...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductAttributeParser
    {
        ...
        List<ProductAttributeCombination> GetCombinationsByProductAttributeValue(Product product, ProductAttributeValue currentAttribute, bool withStock = true);

        /// <summary>
        /// Finds all product attribute combinations by attributes stored in XML 
        /// </summary>
        /// <param name="product">Product</param>
        /// <param name="attributesXml">Attributes in XML format</param>
        /// <param name="ignoreNonCombinableAttributes">A value indicating whether we should ignore non-combinable attributes</param>
        /// <returns>Found product attribute combination</returns>
        List<ProductAttributeCombination> FindAllProductAttributeCombinations(Product product,
            string attributesXml, bool ignoreNonCombinableAttributes = true);
