...
namespace Nop.Services.Catalog
{
    ...
    public partial class ManufacturerService : IManufacturerService
    {
            ...
            bool showHidden = false)
        {
            ...
            query = query.OrderBy(x => x.Name).ThenBy(m => m.DisplayOrder).ThenBy(m => m.Id);
        ...
        public virtual IQueryable<ProductManufacturer> GetProductManufacturers()
        {
            var test = _productManufacturerRepository.Table.Include(x=>x.Manufacturer).Include(x=>x.Product);
            return test;
        }
        #endregion
    }
