...
namespace Nop.Services.Catalog
{
    ...
    public partial class CategoryService : ICategoryService
    {
        ...
        /// <summary>
        /// Gets a product category mapping collection query
        /// </summary>
        /// <returns> Product category mapping collection query</returns>
        public virtual IQueryable<ProductCategory> GetProductCategoriesQuery()
        {
