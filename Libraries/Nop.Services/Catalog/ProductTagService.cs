        ...
        public virtual void UpdateProductTags(Product product, string[] productTags)
        {
            ...
            foreach (var productTag in productTagsToRemove)
            {
                ...
                var productLog = new ProductLog()
                {
                    ...
                    Message = date.ToString("dd-MM-yyyy hh:mm tt") + " - Tag (" + productTag.Id + ") eliminada por " + _workContext.CurrentCustomer.Username + " (" + _workContext.CurrentCustomer.Id + ")."
                };
            ...
            foreach (var productTagName in productTags)
            {
                ...
                if (!product.ProductTagExists(productTag.Id))
                {
                    ...
                    var productLog = new ProductLog()
                    {
                        ...
                        UserId = _workContext.CurrentCustomer.Id,
                        ProductId = product.Id,
                        Message = date.ToString("dd-MM-yyyy hh:mm tt") + " - Tag (" + productTag.Id + ") agregada por " + _workContext.CurrentCustomer.Username + " (" + _workContext.CurrentCustomer.Id + ")."
                    };
