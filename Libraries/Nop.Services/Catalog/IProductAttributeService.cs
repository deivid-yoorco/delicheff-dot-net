...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductAttributeService
    {
        ...
        IList<ProductAttributeMapping> GetAllAttributeMappings();
        ...
        /// </summary>
        /// <returns>Product attribute mapping collection</returns>
        IList<ProductAttributeValue> GetAllProductAttributeValues();
        ...
        /// <param name="productAttributeValueId">Product attribute value identifier</param>
        /// <returns>Product attribute value</returns>
        ProductAttributeValue GetProductAttributeValueBySkuAndColor(string sku, string color);
        ...
        /// <param name="sku">SKU</param>
        /// <returns>Product attribute combination</returns>
        IList<ProductAttributeCombination> GetAllProductAttributeCombinationsBySku(string sku);
