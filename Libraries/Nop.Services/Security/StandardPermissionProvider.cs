...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        //rewards
        public static readonly PermissionRecord ManageRewards = new PermissionRecord { Name = "Admin area. Manage Rewards", SystemName = "ManageRewards", Category = "Configuration" };
        public static readonly PermissionRecord BalanceManager = new PermissionRecord { Name = "Admin area. Manage Balances", SystemName = "BalanceManager", Category = "Configuration" };

        public static readonly PermissionRecord SmsVerification = new PermissionRecord { Name = "Admin area. Sms Verifications", SystemName = "SmsVerification", Category = "Configuration" };
