...
namespace Nop.Services.Discounts.Cache
{
        ...
        IConsumer<EntityDeleted<Manufacturer>>
    {
        ...
        /// <summary>
        /// Key for product IDs of a discount
        /// </summary>
        /// <remarks>
        /// {0} : discount id
        /// {1} : roles of the current user
        /// {2} : current store ID
        /// </remarks>
        public const string DISCOUNT_PRODUCT_IDS_MODEL_KEY = "Nop.discounts.productids-{0}-{1}-{2}";
        public const string DISCOUNT_PRODUCT_IDS_PATTERN_KEY = "Nop.discounts.productids";
        ...
        public void HandleEvent(EntityInserted<Discount> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(DISCOUNT_PRODUCT_IDS_PATTERN_KEY);
        }
