...
namespace Nop.Services.Discounts
{
    ...
    public partial interface IDiscountService
    {
        ...
        /// <param name="customer">Customer</param>
        /// <returns>Manufacturer identifiers</returns>
        IList<int> GetAppliedProductIds(DiscountForCaching discount, Customer customer);
        ...
        /// <summary>
        /// Validate discount without taking in consideration limitation by coupons
        /// </summary>
        /// <param name="discount">Discount</param>
        /// <param name="customer">Customer</param>
        /// <param name="couponCodesToValidate">Coupon codes to validate</param>
        /// <returns>Discount validation result</returns>
        DiscountValidationResult ValidateDiscountWithoutLimitedCouponUsage(Discount discount, Customer customer, string[] couponCodesToValidate);
        ...
        IQueryable<DiscountUsageHistory> GetAllDiscountUsageHistoryQuery();
